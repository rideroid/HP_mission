...
public class Card {
  ...
  public void draw(GL10 gl) {
    ...
    if (angle > 0) {
      ...
      if (axis == AXIS_TOP) {
        if (orientationVertical) {
          h1 = (cardVertices[Y_00] - cardVertices[Y_01]);
          h = Float.parseFloat(String.valueOf(h1* (1.0f - Math.cos(d2r(angle)))));
          z = (cardVertices[Y_00] - cardVertices[Y_01]) * Float.valueOf(String.valueOf(Math.sin(d2r(angle))));
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (1.0f - Float.parseFloat(String.valueOf(Math.cos(d2r(angle)))));
          z = (cardVertices[X_10] - cardVertices[X_00]) * Float.parseFloat(String.valueOf(Math.sin(d2r(angle))));
          shadowVertices = new float[]{
        ...
        if (orientationVertical) {
          h = (cardVertices[Y_00] - cardVertices[Y_01]) * (1f - Float.parseFloat(String.valueOf(Math.cos(d2r(angle)))));
          z = (cardVertices[Y_00] - cardVertices[Y_01]) * Float.parseFloat(String.valueOf(Math.sin(d2r(angle))));
          shadowVertices = new float[]{
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (1f - Float.parseFloat(String.valueOf(Math.cos(d2r(angle)))));
          z = (cardVertices[X_10] - cardVertices[X_00]) * Float.parseFloat(String.valueOf(Math.sin(d2r(angle))));
          shadowVertices = new float[]{
              cardVertices[X_00], cardVertices[Y_00], 0f,
              cardVertices[X_01], cardVertices[Y_01], 0f,
